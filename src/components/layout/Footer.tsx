    ...
    <footer className="bg-accent/50 py-10 mt-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4 gradient-text">TransFormAção</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="text-muted-foreground">Email: contato@transformacao.com</li>
              <li className="text-muted-foreground">Telefone: (00) 0000-0000</li>
              <li className="mt-4 text-xs text-muted-foreground">
                © {currentYear} TransFormAção. Todos os direitos reservados.
              </li>
            </ul>
          </div>
        </div>
